		...
		>
			...
			<div className='lg:w-1/2 sm:text-3xl text-lg'>
				<p className='mb-16'>
					...
					JavaScript and expertise in .NET Core. I'm a quick learner
					and collaborate closely with clients to create effecient and
					user-friendly solutions that solve real world problems.
					Let's work together and bring your ideas to life!
				</p>
				<p className='mb-16'>
					I began programming in high school with VB.NET. I then
					enrolled at New Brunswick Community College / NBCC where I
					majored in Web and Mobile application development. After two
					years of training at NBCC I graduated with honours.
				</p>
				<p className='mb-16'>
					...
					migrated their application from a traditional data center to
					Amazon Web Services. I also maintained and expanded upon
